...
<body>
	...
	<div class="container">
		<div id="#sucesso" style="display: none" class="alert alert-success text-center">
			<span class="glyphicon glyphicon-star"></span> Cliente adicionado com Sucesso!
		</div>
	</div>
	<div class="container">
		<form id="formCliente" method="POST" class="form-horizontal">
			<fieldset>
				<!-- Form Name -->
				<legend class="text-center">Novo Cliente</legend>
				<!-- nome input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="nome">Nome</label>
					<div class="col-md-4">
						<input id="nome" name="nome" type="text" placeholder="Digite aqui o seu nome" class="form-control input-md">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="cpf" name="cpf" type="text" placeholder="Digite aqui o seu cpf"
