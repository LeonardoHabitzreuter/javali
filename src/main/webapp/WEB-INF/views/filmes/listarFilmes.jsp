		...
		<table class="table toggle-circle-filled table-striped table-hover">
			<thead>
				<tr>
					...
					<th class="text-center col-md-0" data-hide="tablet, phone">Cpf</th>
				...
				<c:forEach var="cliente" items="${clientes}">
					<tr>
						...
						<td class="text-center"><a
							href="formAtualizarCliente?id=${cliente.id}&nome=${cliente.nome}&cpf=${cliente.cpf}&senha=${cliente.senha}"
